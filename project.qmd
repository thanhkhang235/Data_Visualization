...
# Find the minimum non-NA value in the 'ratio' column
min_ratio_value <- min(plot_data$ratio, na.rm = TRUE)

# Replace NA values with the minimum 'ratio' value
plot_data$ratio[is.na(plot_data$ratio)] <- min_ratio_value

# Remove rows with missing values in the necessary columns
plot_data <- plot_data[complete.cases(plot_data), ]

# Adjust the color scale with log10 transformation
ggplot() +
