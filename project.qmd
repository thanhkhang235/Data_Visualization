...
```
## I can not fix it, I don't understand why they have the same length in region (49 state), but they are not match 100%, so there are 2 missing values in the map plot: alaska and hawaii. 
